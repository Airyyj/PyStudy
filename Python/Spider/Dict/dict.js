	...
	return function(e, t) {
		...
		function l(e) {
			...
			if (e.liveFired !== this && m && m.live && !e.target.disabled && (!e.button || "click" !== e.type)) {
				...
				for (i = H(e.target).closest(h, e.currentTarget), l = 0, u = i.length; u > l; l++) for (c = i[l], s = 0; s < g.length; s++) o = g[s], c.selector !== o.selector || f && !f.test(o.namespace) || c.elem.disabled || (a = c.elem, r = null, ("mouseenter" === o.preType || "mouseleave" === o.preType) && (e.type = o.preType, r = H(e.relatedTarget).closest(o.selector)[0], r && H.contains(a, r) && (r = a)), r && r === a || p.push({
					elem: a,
					handleObj: o,
					level: c.level
				}));
			...
			if (1 === t.nodeType && H.hasData(e)) {
				...
				if (r = r[n]) {
					...
					if (i = i[n] = H.extend({}, r), o) {
						...
						for (var a in o) for (var s = 0, l = o[a].length; l > s; s++) H.event.add(t, a + (o[a][s].namespace ? "." : "") + o[a][s].namespace, o[a][s], o[a][s].data)
					}
				}
			}
		}
		...
		function x(e) {
			return function(t, n) {
				if ("string" != typeof t && (n = t, t = "*"), H.isFunction(n)) for (var r, i, o, a = t.toLowerCase().split(Ze), s = 0, l = a.length; l > s; s++) r = a[s], o = /^\+/.test(r), o && (r = r.substr(1) || "*"), i = e[r] = e[r] || [], i[o ? "unshift" : "push"](n)
			}
		}
		...
		var L = e.document,
			...
			H = function() {
				...
				}), i = s.uaMatch(S), i.browser && (s.browser[i.browser] = !0, s.browser.version = i.version), s.browser.webkit && (s.browser.safari = !0), f.test("聽") && (d = /^[\s\xA0]+/, p = /[\s\xA0]+$/), r = s(L), L.addEventListener ? a = function() {
		...
		H.extend({
			...
			data: function(e, r) {
				...
				if ("undefined" == typeof e) {
					if (this.length && (i = H.data(this[0]), 1 === this[0].nodeType)) for (var o, a = this[0].attributes, s = 0, l = a.length; l > s; s++) o = a[s].name, 0 === o.indexOf("data-") && (o = H.camelCase(o.substring(5)), n(this[0], o, i[o]));
					return i
				}
		...
		H.fn.extend({
			...
			toggleClass: function(e, t) {
				...
				function(n) {
					...
					if ("string" === n) for (var i, o = 0, a = H(this), s = t, l = e.split($); i = l[o++];) s = r ? s : !a.hasClass(i), a[s ? "addClass" : "removeClass"](i);
			...
			hasClass: function(e) {
				for (var t = " " + e + " ", n = 0, r = this.length; r > n; n++) if ((" " + this[n].className + " ").replace(W, " ").indexOf(t) > -1) return !0;
				return !1
			},
			val: function(e) {
				var n, r, i = this[0];
			...
			remove: function(e, n, r, i) {
				if (3 !== e.nodeType && 8 !== e.nodeType) {
					...
					if (y && v) if (n && n.type && (r = n.handler, n = n.type), !n || "string" == typeof n && "." === n.charAt(0)) {
						...
						} else for (l = 0; l < p.length; l++) h = p[l], (u || f.test(h.namespace)) && (H.event.remove(e, m, h.handler, l), p.splice(l--, 1));
		...
		H.support.focusinBubbles || H.each({
			...
			H.fn[n] = function(e, r, i) {
				...
				else for (var s = 0, l = this.length; l > s; s++) H.event.add(this[s], e, o, r);
				return this
			}
		}), H.fn.extend({
			unbind: function(e, t) {
				if ("object" != typeof e || e.preventDefault) for (var n = 0, r = this.length; r > n; n++) H.event.remove(this[n], e, t);
		...
		H.each(["live", "die"], function(e, n) {
			H.fn[n] = function(e, r, i, a) {
				...
				for ((r === !1 || H.isFunction(r)) && (i = r || o, r = t), e = (e || "").split(" "); null != (s = e[d++]);) if (l = G.exec(s), c = "", l && (c = l[0], s = s.replace(G, "")), "hover" !== s) if (f = s, se[s] ? (e.push(se[s] + c), s += c) : s = (se[s] || s) + c, "live" === n) for (var g = 0, y = h.length; y > g; g++) H.event.add(h[g], "live." + u(s, p), {
					data: r,
					selector: p,
					handler: i,
					origType: s,
		...
		Ee.optgroup = Ee.option, Ee.tbody = Ee.tfoot = Ee.colgroup = Ee.caption = Ee.thead, Ee.th = Ee.td, H.support.htmlSerialize || (Ee._default = [1, "div<div>", "</div>"]), H.fn.extend({
			...
			var r, i, o, a;
			return t && t[0] && (a = t[0].ownerDocument || t[0]), a.createDocumentFragment || (a = L), 1 === e.length && "string" == typeof e[0] && e[0].length < 512 && a === L && "<" === e[0].charAt(0) && !Te.test(e[0]) && (H.support.checkClone || !we.test(e[0])) && (i = !0, o = H.fragments[e[0]], o && 1 !== o && (r = o)), r || (r = a.createDocumentFragment(), H.clean(e, a, r, n)), i && (H.fragments[e[0]] = o ? r : 1), {
				fragment: r,
				cacheable: i
			}
		}, H.fragments = {}, H.each({
			...
			cleanData: function(e) {
				for (var t, n, r, i = H.cache, o = H.expando, a = H.event.special, s = H.support.deleteExpando, l = 0; null != (r = e[l]); l++) if ((!r.nodeName || !H.noData[r.nodeName.toLowerCase()]) && (n = r[H.expando])) {
			...
			ajax: function(e, n) {
				function r(e, n, r, a) {
					if (2 !== x) {
						...
						if (e >= 200 && 300 > e || 304 === e) if (d.ifModified && ((b = w.getResponseHeader("Last-Modified")) && (H.lastModified[i] = b), (T = w.getResponseHeader("Etag")) && (H.etag[i] = T)), 304 === e) n = "notmodified", u = !0;
						else try {
		...
		H.fn.extend({
			...
			hide: function(e, t, n) {
				...
				for (var r = 0, i = this.length; i > r; r++) if (this[r].style) {
...
define("/atEntrance", function(e, t) {
	...
	var r = function(e) {
			...
			function s(e) {
				...
				for (var s = [], l = [], u = 0, p = 0, h = 0, m = 0, g = 0, v = !1, y = !1, b = 0, x = e.length; x > b; b++) {
					...
					if (t(T) || r(T) ? (w = N = !0, u++) : o(T) ? (v || (v = !0), N = !0) : i(T) ? (y || (y = !0), w = !0) : a(T) ? (w = N = !0, p++) : (w = N = !0, h++), v && (w || b == x - 1) || y && (N || b == x - 1)) {
						...
						S.length > 10 && m++, v ? s[s.length] = S : y && (l[l.length] = S), (v || y) && (g = b), v = !1, y = !1
					}
					w && N && (g = b + 1, v = !1, y = !1)
				}
				var E = l.length,
			...
			for (var l = null, u = null, c = 0, f = 1, d = 2, p = "en", h = "zh", m = [
				...
				[8250, 12297, 12299]
			], v = {}, y = 0; y < m.length; y++) for (var b = 0; b < m[y].length; b++) v[m[y][b].charCodeAt(0)] = !0;
			for (var y = 0; y < g.length; y++) for (var b = 0; b < g[y].length; b++) v[g[y][b] - 1] = !0, v[g[y][b]] = !0;
			var x = [48, 57],
				T = [65296, 65305],
				w = [65, 90],
				N = [97, 122],
	...
	function(e, t) {
		...
		var n, r, i, a = e,
			...
			ee = function(e, r) {
				...
				if (o && o.length) {
					for (i = 0, a = o.length; a > i; i++) e = o[i].replace(/^on/, ""), s[e] = !0, z[e] || (z[e] = []), z[e].push(r);
			...
			te = function(e, t) {
				...
				if (a && a.length) for (n = 0, r = a.length; r > n; n++) if (e = a[n].toLowerCase().replace(/^on/, ""), o = z[e], o && o.length) if (t) for (i = o.indexOf(t); - 1 !== i;) o.splice(i, 1), i = o.indexOf(t, i);
				else o.length = 0;
				return Ve
			},
			ne = function(e) {
			...
			re = function(e) {
				var t, n, r;
				return e = pe(e), e && !xe(e) ? "ready" === e.type && P.overdue === !0 ? Ve.emit({
					type: "error",
					name: "flash-overdue"
			...
			ie = function() {
				var e = P.sandboxed;
				if (We(), "boolean" != typeof P.ready && (P.ready = !1), P.sandboxed !== e && P.sandboxed === !0) P.ready = !1, Ve.emit({
					type: "error",
					...
					"number" == typeof t && t >= 0 && (R = l(function() {
						"boolean" != typeof P.deactivated && (P.deactivated = !0), P.deactivated === !0 && Ve.emit({
							type: "error",
			...
			xe = function(e) {
				...
				case "error":
					...
					"boolean" == typeof o && (P.sandboxed = o), -1 !== Z.indexOf(e.name) ? E(P, {
			...
			Ne = function() {
				...
				return e.id = J.containerId, e.className = J.containerClass, e.style.position = "absolute", e.style.left = "0px", e.style.top = "-9999px", e.style.width = "1px", e.style.height = "1px", e.style.zIndex = "" + Re(J.zIndex), e
			},
			Ee = function(e) {
			...
			Se = function() {
				...
				return t || (t = o[J.swfObjectId], t && (e = t.length) && (t = t[e - 1]), !t && n && (t = n.firstChild)), P.bridge = t || null, t
			},
			Ae = function() {
				var e = P.bridge;
				if (e) {
					var r = Ee(e);
					r && ("activex" === P.pluginType && "readyState" in e ? (e.style.display = "none", function i() {
						if (4 === e.readyState) {
					...
					}()) : (e.parentNode && e.parentNode.removeChild(e), r.parentNode && r.parentNode.removeChild(r))), ze(), P.ready = null, P.bridge = null, P.deactivated = null, n = t
				}
			},
			ke = function(e) {
				var t = {},
			...
			Re = function(e) {
				...
				var t;
				return "number" != typeof e || y(e) ? "string" == typeof e && (t = Re(g(e, 10))) : t = e, "number" == typeof t ? t : "auto"
			},
			We = function(t) {
				...
				return P.sandboxed = o, a === o || t || Xe(h), o
			},
			Xe = function(e) {
				function t(e) {
					var t = e.match(/[\d]+/g);
				...
				P.disabled = l !== !0, P.outdated = f && v(f) < v(_), P.version = f || "0.0.0", P.pluginType = c ? "pepper" : u ? "activex" : l ? "netscape" : "unknown"
			};
		Xe(h), We(!0);
		var Ve = function() {
		...
		var Ke = function(e) {
			...
			et = function(e, t) {
				...
				if (a && a.length) for (n = 0, r = a.length; r > n; n++) if (e = a[n].toLowerCase().replace(/^on/, ""), o = l[e], o && o.length) if (t) for (i = o.indexOf(t); - 1 !== i;) o.splice(i, 1), i = o.indexOf(t, i);
				else o.length = 0;
				return this
			},
			tt = function(e) {
...
define("/css3-mediaqueries", function(e, t) {
	...
	var r = function() {
			...
			return document.addEventListener && document.addEventListener("DOMContentLoaded", t, !1), n.ie && (!
			function() {
				try {
...
define("/tips", function(e, t) {
	...
	t.hide = function(e) {
		...
		n.hide(), n.find(".error_text").html(e), n.removeClass("beyondText"), "璇疯緭鍏ュ唴瀹�" === e ? n.addClass("nullError") : n.removeClass("nullError"), n.fadeIn()
	}, t.init = function() {
...
define("/output/voice", function(e, t) {
	...
	t.stopVoice = function() {
		...
		n("#fanyivoice").length <= 0 && a(), ("zh-CHS2en" == e || "zh-CHS2ja" == e || "zh-CHS2ko" == e || "zh-CHS2fr" == e) && c() <= 300 ? i.show() : i.hide()
	}, t.init = function() {
...
define("/output/copy", function(e, t) {
	...
	t.init = function() {
		if (!(n("#copyit").length > 0)) if (n.browser.msie) {
			...
			e.click(function() {
				return r(), n(".copy-notice").text("宸插鍒�"), n(this).text("").blur(), setTimeout(function() {
			...
			t.on("ready", function(e) {
				t.on("copy", function(e) {
					e.clipboardData.setData("text/plain", getTranslatedResult()), n(".copy-notice").text("宸插鍒�"), setTimeout(function() {
						n(".copy-notice").text("澶嶅埗")
					}, 500)
...
define("/output/result", function(e, t) {
	var n, r = e("/lib/jquery-1.6.2"),
		...
		u = function() {
			...
			t ? "鑷姩妫€娴嬭瑷€" == r(".btn_text").text() || -1 != r("#outputLang").text().indexOf("妫€娴嬪埌") ? (r(".btn_text").html(""), r("#outputLang").html("妫€娴嬪埌锛�" + t)) : (r(".btn_text").html(""), r("#outputLang").html(t)) : (r(".btn_text").html("妫€娴嬪埌锛氭殏涓嶆敮鎸佺殑璇█"), r("#outputLang").html("")), r("#main").addClass("show-translate"), e("/example").hide(), i.html(l(n.translateResult, !n.smartResult, n.type)), r("#translated").show(), e("/output/voice").showVoice(n.type)
		};
	t.show = function() {
...
define("/output/output", function(e, t) {
	...
	t.getTransResult = d, t.translate = function(e) {
		...
		i = t, r = n, e("/output/bilingualControl").init(), s(), e("/output/typo").init(), e("/output/readingMode").initReadingMode(), "true" === a.cookie("YOUDAO_FANYI_REALTIME_CLOSE") && (o(".close-realtime-mode").html("寮€鍚嵆鏃剁炕璇�"), global.realTime = !1), o(".close-realtime-mode").click(function() {
			return global.realTime ? (o(this).html("寮€鍚嵆鏃剁炕璇�"), a.cookie("YOUDAO_FANYI_REALTIME_CLOSE", "true"), e("/log").clog("FY_REALTIME_CLOSE", ""), global.realTime = !1) : (o(this).html("鍏抽棴鍗虫椂缈昏瘧"), e("/log").clog("FY_REALTIME_OPEN", ""), a.cookie("YOUDAO_FANYI_REALTIME_CLOSE", "false"), global.realTime = !0), !1
...
define("/lib/md5", function(e, t) {
	var n = e("/lib/jquery-1.6.2"),
		...
		u = function(e, t, n, a, s, l, u) {
			return e = i(e, i(i(o(t, n, a), s), u)), i(r(e, l), t)
		},
		c = function(e, t, n, o, s, l, u) {
			return e = i(e, i(i(a(t, n, o), s), u)), i(r(e, l), t)
		},
		d = function(e, t, n, o, a, l, u) {
			return e = i(e, i(i(s(t, n, o), a), u)), i(r(e, l), t)
		},
		f = function(e, t, n, o, a, s, u) {
			return e = i(e, i(i(l(t, n, o), a), u)), i(r(e, s), t)
		},
		p = function(e) {
			for (var t, n = e.length, r = n + 8, i = (r - r % 64) / 64, o = 16 * (i + 1), a = Array(o - 1), s = 0, l = 0; n > l;) t = (l - l % 4) / 4, s = l % 4 * 8, a[t] = a[t] | e.charCodeAt(l) << s, l++;
			return t = (l - l % 4) / 4, s = l % 4 * 8, a[t] = a[t] | 128 << s, a[o - 2] = n << 3, a[o - 1] = n >>> 29, a
		},
		h = function(e) {
			var t, n, r = "",
				i = "";
			for (n = 0; 3 >= n; n++) t = e >>> 8 * n & 255, i = "0" + t.toString(16), r += i.substr(i.length - 2, 2);
			return r
		},
		m = function(e) {
	...
	n.extend({
		md5: function(e) {
			var t, n, r, o, a, s, l, g, v, y = Array(),
				...
				F = 15,
				H = 21;
			for (e = m(e), y = p(e), s = 1732584193, l = 4023233417, g = 2562383102, v = 271733878, t = 0; t < y.length; t += 16) n = s, r = l, o = g, a = v, s = u(s, l, g, v, y[t + 0], b, 3614090360), v = u(v, s, l, g, y[t + 1], x, 3905402710), g = u(g, v, s, l, y[t + 2], w, 606105819), l = u(l, g, v, s, y[t + 3], C, 3250441966), s = u(s, l, g, v, y[t + 4], b, 4118548399), v = u(v, s, l, g, y[t + 5], x, 1200080426), g = u(g, v, s, l, y[t + 6], w, 2821735955), l = u(l, g, v, s, y[t + 7], C, 4249261313), s = u(s, l, g, v, y[t + 8], b, 1770035416), v = u(v, s, l, g, y[t + 9], x, 2336552879), g = u(g, v, s, l, y[t + 10], w, 4294925233), l = u(l, g, v, s, y[t + 11], C, 2304563134), s = u(s, l, g, v, y[t + 12], b, 1804603682), v = u(v, s, l, g, y[t + 13], x, 4254626195), g = u(g, v, s, l, y[t + 14], w, 2792965006), l = u(l, g, v, s, y[t + 15], C, 1236535329), s = c(s, l, g, v, y[t + 1], T, 4129170786), v = c(v, s, l, g, y[t + 6], E, 3225465664), g = c(g, v, s, l, y[t + 11], S, 643717713), l = c(l, g, v, s, y[t + 0], N, 3921069994), s = c(s, l, g, v, y[t + 5], T, 3593408605), v = c(v, s, l, g, y[t + 10], E, 38016083), g = c(g, v, s, l, y[t + 15], S, 3634488961), l = c(l, g, v, s, y[t + 4], N, 3889429448), s = c(s, l, g, v, y[t + 9], T, 568446438), v = c(v, s, l, g, y[t + 14], E, 3275163606), g = c(g, v, s, l, y[t + 3], S, 4107603335), l = c(l, g, v, s, y[t + 8], N, 1163531501), s = c(s, l, g, v, y[t + 13], T, 2850285829), v = c(v, s, l, g, y[t + 2], E, 4243563512), g = c(g, v, s, l, y[t + 7], S, 1735328473), l = c(l, g, v, s, y[t + 12], N, 2368359562), s = d(s, l, g, v, y[t + 5], k, 4294588738), v = d(v, s, l, g, y[t + 8], A, 2272392833), g = d(g, v, s, l, y[t + 11], L, 1839030562), l = d(l, g, v, s, y[t + 14], D, 4259657740), s = d(s, l, g, v, y[t + 1], k, 2763975236), v = d(v, s, l, g, y[t + 4], A, 1272893353), g = d(g, v, s, l, y[t + 7], L, 4139469664), l = d(l, g, v, s, y[t + 10], D, 3200236656), s = d(s, l, g, v, y[t + 13], k, 681279174), v = d(v, s, l, g, y[t + 0], A, 3936430074), g = d(g, v, s, l, y[t + 3], L, 3572445317), l = d(l, g, v, s, y[t + 6], D, 76029189), s = d(s, l, g, v, y[t + 9], k, 3654602809), v = d(v, s, l, g, y[t + 12], A, 3873151461), g = d(g, v, s, l, y[t + 15], L, 530742520), l = d(l, g, v, s, y[t + 2], D, 3299628645), s = f(s, l, g, v, y[t + 0], j, 4096336452), v = f(v, s, l, g, y[t + 7], O, 1126891415), g = f(g, v, s, l, y[t + 14], F, 2878612391), l = f(l, g, v, s, y[t + 5], H, 4237533241), s = f(s, l, g, v, y[t + 12], j, 1700485571), v = f(v, s, l, g, y[t + 3], O, 2399980690), g = f(g, v, s, l, y[t + 10], F, 4293915773), l = f(l, g, v, s, y[t + 1], H, 2240044497), s = f(s, l, g, v, y[t + 8], j, 1873313359), v = f(v, s, l, g, y[t + 15], O, 4264355552), g = f(g, v, s, l, y[t + 6], F, 2734768916), l = f(l, g, v, s, y[t + 13], H, 1309151649), s = f(s, l, g, v, y[t + 4], j, 4149444226), v = f(v, s, l, g, y[t + 11], O, 3174756917), g = f(g, v, s, l, y[t + 2], F, 718787259), l = f(l, g, v, s, y[t + 9], H, 3951481745), s = i(s, n), l = i(l, r), g = i(g, o), v = i(v, a);
...
define("/output/rankScore", function(e, t) {
	var n = e("/lib/jquery-1.6.2"),
		...
		o = function(t) {
			t.addClass("rateOn"), n("#rating_1").addClass("cover_rate"), n("#star .star_show").css("display", "none"), n("#star .star_result").css("display", "block"), n("#resultScore").css("background-position", "0px 0px");
			var i = u();
			a({
...
define("/input/input", function(e, t) {
	...
	var a, s, l, u, c, d, f = 500,
		...
		m = function() {
			...
			o.showAtButton("", t), -1 != n("#outputLang").text().indexOf("妫€娴嬪埌") && (n(".btn_text").html("鑷姩妫€娴嬭瑷€"), n("#outputLang").html(""))
		},
		g = function(e) {
			a.val(h().replace(/\n/g, "").replace(/\r\n/g, ""));
			var t = a.val();
		...
		v = function(t) {
			...
			if ("AUTO" != o && p(), n("#wordCurrent").hasClass("beyond")) {
				...
				d = h.substr(0, 5e3);
				var m = h.substr(5e3);
				m = m.trim(), m = m.substr(0, 3), r.show("瀛楁暟闄愬埗涓�5000瀛楋紝鈥�" + m + "鈥濆強鍏跺悗闈㈡病鏈夎缈昏瘧!"), n("#errorHolder").addClass("beyondText")
			}
			var g = n.md5(u + d + f + c);
		...
		b = function(t, n) {
			...
			var o = h();
			y = o, o.length > 0 ? (s.fadeIn(), r.hide("allExceptWelcome"), i.isWeb(o) ? g(n) : v(n)) : (a.focus(), r.show("璇疯緭鍏ュ唴瀹�"))
		},
		x = function() {
			var e = new Date;
	...
	t.getExpectCost = function(e) {
		...
		function t() {
			var e = a.val();
			d.text(e.length), e.length > 5e3 ? d.addClass("beyond") : d.removeClass("beyond")
		}
		...
		a.focus(function() {
			"" !== h() ? s.show() : s.hide(), o.showAtButton(h(), n("#customSelectVal").val())
		}), p(), a.bind("textchange", function(r, i) {
			e("/output/typo").hide(), o.timero(function() {
				o.showAtButton(h(), n("#customSelectVal").val()), t()
			}, 100).run()
		}), a.keyup(function(t) {
			a.val().length > 0 ? s.show() : m(), t.ctrlKey && 13 == t.keyCode || 13 == t.keyCode ? (t.ctrlKey && 13 == t.keyCode && b(!1, "FY_BY_CTRL_ENTER"), 13 == t.keyCode && b(!1, "FY_BY_ENTER"), e("/input/advert").reloadSP()) : global.realTime && y !== h() && i.timerProxy(function() {
				b(!0, "FY_BY_REALTIME")
			}, f), t.stopPropagation()
		}), s.click(function() {
			return e("/log").clog("CLEAN_CLICK", "web.i.clean"), m(), t(), a.focus(), u.hover(function() {
				n("#atBtnhover").css("display", "none")
			}), !1
			...
			return b(!1, "FY_BY_CLICKBUTTION"), e("/input/advert").reloadSP(), !1
		}), u.click(function() {
			if ("button atDisableBtn" !== this.className) {
				var e = document.getElementById("mapForm"),
					t = document.getElementById("mapInput");
				t ? t.value = h() : (t = document.createElement("input"), t.id = "mapInput", t.type = "hidden", t.name = "text", t.value = h(), e.appendChild(t)), e.submit(), c.click()
			}
			return !1
			...
			if ("" !== h()) {
				var r = /[\u4E00-\u9FA5]/i,
					...
					o = w(h().length, i);
				u.hover(function() {
					n(".time-num").html(o + "鍒嗛挓"), n("#atBtnhover").css("display", "block")
				}, function() {
					n("#atBtnhover").css("display", "none")
				})
